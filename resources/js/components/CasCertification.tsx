...
const CasCertification: React.FC = () => {
                    ...
                    <div className="car-content">
                        ...
                        <div className="car-body">
                            ...
                            <p className="car-para1">
                                for having satisfactorily <strong>completed all the academic subjects </strong> of the degree,
...
export default CasCertification;